      ...
      <div className="season-container">
        <div className="row">
          <div className="col-5 season-poster">
            <Link href={`/serie/${serieID}/season/${season.season_number}`}>
              <img
                src={
                  season?.poster_path
          ...
          <div className="col-7 p-4">
            <Link href={`/serie/${serieID}/season/${season.season_number}`} className="text-dark">
              <h5 className="season-name">{season?.name}</h5>
            </Link>
            <div className="season-info">{`${season?.air_date?.split('-')[0]} | ${season?.episode_count} Episodes`}</div>
