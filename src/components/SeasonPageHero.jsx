              ...
              <div className="col-12 col-lg-7">
                <div className="movie-information">
                  <h1 className="movie-title">
                    {serie?.name}{' '}
                    <span className="movie-release-date">{`(${season?.name})`}</span>
                  </h1>
                  ...
                  <div className="work-description py-3">{season?.overview || serie?.overview}</div>
                  <div className="work-actions-btns">
                    <Link
                      href={`/watch/serie/${serie?.id}/season/${season?.season_number}/episode/1`}
                      className="btn me-3"
                    >
