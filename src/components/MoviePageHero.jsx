                ...
                <div className="movie-information">
                  ...
                  <div className="work-info d-flex">
                    ...
                    <span className="work-info-tag age-class">
                      {movie?.release_dates?.results?.find((el) =>
                        el?.release_dates?.find((r) => r?.certification !== '')
                  ...
                  {btns ? (
                    <div className="work-actions-btns">
                      <Link href={`/watch/movie/${movie.id}`} className="btn me-3">
                        <i className="fal fa-play me-3"></i>watch trailer
                      </Link>
                      {movie?.homepage ? (
                        <a href={movie?.homepage} target="_blank" rel="noreferrer" className="btn me-3 info-link-btn">
                          Visit Website
                        </a>
                      ) : null}
                    </div>
